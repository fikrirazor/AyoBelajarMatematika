...
func pertanyaan():
	...
	var randomsalah0
	while true:
		randomsalah0 = rand.randi_range(nilaiAwal-nilaiAkhir,nilaiAkhir-nilaiAwal)
	...
	var randomsalah1
	while true:
		randomsalah1 = rand.randi_range(nilaiAwal-nilaiAkhir,nilaiAkhir-nilaiAwal)
